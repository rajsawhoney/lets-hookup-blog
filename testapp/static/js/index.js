...
$(document).on("submit", "form.delete-post", function (env) {
  ...
  $(".delete-confirm").html(
    '<span class="spinner-border spinner-border-sm" role="status"></span> <span class="light">Post Deleting...</span>'
  );
  $.ajax({
    type: "post",
    ...
    success: function (response) {
      $(".delete-confirm").html(
        '<span class="spinner-border spinner-border-sm" role="status"></span> <span class="light">Post Deleted!</span>'
      );
...
$(document).on("submit", ".updateform", function (event) {
  ...
  $("#update-spinner").html(
    '<span class="spinner-border spinner-border-sm" role="status"></span> <span class="light">Updating...</span>'
  );
  $.ajax({
    type: "POST",
    url: url,
...
function toggle_mode() {
  $("#mode-toggler").html(
    '<span class="spinner-border spinner-border-sm" role="status"></span> <span class="light">Toggling Mode...</span>'
  );
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (dark_mode) {
        $("#toggle-mode").attr(
          "href",
          "https://lets-hookup.herokuapp.com/static/css/dark-mode.css"
        );
        $("#mode-toggler").html(
          '<i class="fa fa-2x fa-globe" aria-hidden="true"></i><span style="font-size: large;"> Back To Light Mode</span>'
        );
      }
      if (!dark_mode) {
        $("#toggle-mode").attr(
          "href",
          "https://lets-hookup.herokuapp.com/static/css/light-mode.css"
        );
        $("#mode-toggler").html(
